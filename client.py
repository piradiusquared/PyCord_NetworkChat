...
def init_user(sock: socket.socket):
    ...
    sock.send((USERNAME_PREFIX + username).encode())
...
def create_connection(host, port):
    ...
    try:
        ...
        # Function
        #sock.send("DSPLYACTVCONNS".encode()) # Get server to instantly send messages        
        active_connections = sock.recv(1024)
        print(active_connections.decode())
